      ...
      <div id="pg-home" className="page active">
        ...
        <div className="appsec">
          ...
          <div className="fgrid rv">
            {['logo-morganstanley.png','logo-bofa.png','logo-wellsfargo.png','logo-deutschebank.png','logo-evercore.png','logo-lazard.png','logo-jefferies.png','logo-pipersandler.png','logo-point72.png','logo-raymondjames.png','logo-jpmorgan.png','logo-santander.png','logo-truist.png','logo-lincolninternational.png','logo-deloitte.png'].map((logo,i) => (
