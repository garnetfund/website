      ...
      <div id="pg-home" className="page active">
        ...
        <div className="appsec" style={{borderBottom:'1px solid var(--rl)'}}>
          ...
          <div style={{maxWidth:'760px'}}>
            ...
            <p className="appbody rv">Garnet Fund is a student-managed investment fund at the Darla Moore School of Business. Founded in 2026, over 35 undergraduate students manage a real equity and alternatives portfolio each fall. This year we are starting with $110,000 under management, with a five-year goal of reaching $1 million in AUM.</p>
        ...
        <div className="appsec">
          ...
          <div className="fgrid rv">
            {['logo-morganstanley.png','logo-bofa.png','logo-wellsfargo.png','logo-deutschebank.png','logo-evercore.png','logo-lazard.png','logo-jefferies.png','logo-pipersandler.png','logo-point72.png','logo-raymondjames.png','logo-truist.png','logo-cboe.png'].map((logo,i) => (
        ...
        <div className="tmp" style={{paddingTop:'40px'}}>
          ...
          <div className="lgrid rv">
            {[
              ...
              {slug:'preston-schlagheck',ini:'AG',name:'Preston Schlagheck',role:'Head of Technology',year:'2028'},
            ].map((m,i) => (
      ...
      <div id="pg-join" className="page">
        <div className="jp" style={{paddingTop:'40px'}}>
          <div style={{maxWidth:'640px',marginBottom:'48px'}}>
            ...
            <p className="jb rv">Applications for Fall 2026 are now open. The deadline to apply is September 10th.</p>
          ...
          <div className="apsteps">
            ...
            <div className="aps rv"><div className="apsr">Round III</div><div className="apst">Case Study</div><div className="apsd">Finalists complete a take-home case study and present it to two members of the executive team.</div><div className="apsn">3</div></div></div><div className="appsec" style={{borderTop:"1px solid var(--rl)",paddingTop:"48px"}}><div className="sl rv">Contact</div><div style={{marginTop:"0"}}><h2 className="st rv">Have questions?</h2><p style={{fontFamily:"var(--fp)",fontSize:"14px",color:"var(--i60)",lineHeight:"1.85",marginBottom:"2rem",marginTop:"16px"}}>Feel free to reach out to us directly.</p><div style={{display:"flex",flexDirection:"column",gap:"1.25rem"}}><div><p style={{fontFamily:"var(--fs)",fontSize:"13px",fontWeight:600,color:"var(--ink)",marginBottom:"4px"}}>Arav Patel - President</p><a href="mailto:garnetinvestmentfund@gmail.com" style={{fontFamily:"var(--fs)",fontSize:"13px",color:"var(--g)",textDecoration:"none",borderBottom:"1px solid var(--g)",paddingBottom:"2px"}}>garnetinvestmentfund@gmail.com</a></div><div><p style={{fontFamily:"var(--fs)",fontSize:"13px",fontWeight:600,color:"var(--ink)",marginBottom:"4px"}}>Sophia McCoy - Head of Operations</p><a href="mailto:garnetfundoperations@gmail.com" style={{fontFamily:"var(--fs)",fontSize:"13px",color:"var(--g)",textDecoration:"none",borderBottom:"1px solid var(--g)",paddingBottom:"2px"}}>garnetfundoperations@gmail.com</a></div></div>
          </div>
        </div>
      </div>
</div>
        ...
        <div className="dp" style={{paddingTop:'60px'}}>
          ...
          <div className="dl">
            <div>
              ...
              <p className="db rv">If you're interested in donating, press the "Donate via Give 4 Garnet" box, enter "677 Garnet Fund" in the "Search Funds" box, and fill out the rest of the information accordingly. Thank you for your donation!</p>
              ...
              <div style={{marginTop:'5rem',width:'75%',marginLeft:'auto',marginRight:'auto'}}><div className="sl" style={{marginBottom:'8px'}}>Alumni Contact</div><p style={{fontFamily:'var(--fp)',fontSize:'14px',color:'var(--i60)',lineHeight:'1.85',marginBottom:'1rem',marginTop:'16px'}}>If you have questions, please feel free to reach out to us directly.</p><p style={{fontFamily:'var(--fp)',fontSize:'14px',color:'var(--i60)',lineHeight:'1.85',marginBottom:'2rem'}}>We are constantly striving to provide more opportunities for our students. If any alumni are interested in speaking to Garnet Fund about their careers at one of our meetings, it would be greatly appreciated. Please reach out to the contacts below.</p><div style={{display:'flex',flexDirection:'column',gap:'2rem'}}><div><p style={{fontFamily:'var(--fs)',fontSize:'13px',fontWeight:600,color:'var(--ink)',marginBottom:'4px'}}>Arav Patel - President</p><a href="mailto:garnetinvestmentfund@gmail.com" style={{fontFamily:'var(--fs)',fontSize:'13px',color:'var(--g)',textDecoration:'none',borderBottom:'1px solid var(--g)',paddingBottom:'2px'}}>garnetinvestmentfund@gmail.com</a></div><div><p style={{fontFamily:'var(--fs)',fontSize:'13px',fontWeight:600,color:'var(--ink)',marginBottom:'4px'}}>Julia Judkins - Alumni Chair</p><a href="mailto:garnetfundalumnichair@gmail.com" style={{fontFamily:'var(--fs)',fontSize:'13px',color:'var(--g)',textDecoration:'none',borderBottom:'1px solid var(--g)',paddingBottom:'2px'}}>garnetfundalumnichair@gmail.com</a></div></div></div>
             </div>
