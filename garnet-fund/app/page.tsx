        ...
        <div className="dp" style={{paddingTop:'60px'}}>
          ...
          <div className="dl">
            <div>
              ...
              <div style={{marginTop:"0"}}><h2 className="st rv">Have questions?</h2><p style={{fontFamily:"var(--fp)",fontSize:"14px",color:"var(--i60)",lineHeight:"1.85",marginBottom:"2rem",marginTop:"16px"}}>Feel free to reach out to us directly.</p><div style={{display:"flex",flexDirection:"column",gap:"1.25rem"}}><div><p style={{fontFamily:"var(--fs)",fontSize:"13px",fontWeight:600,color:"var(--ink)",marginBottom:"4px"}}>Arav Patel - President</p><a href="mailto:garnetinvestmentfund@gmail.com" style={{fontFamily:"var(--fs)",fontSize:"13px",color:"var(--g)",textDecoration:"none",borderBottom:"1px solid var(--g)",paddingBottom:"2px"}}>garnetinvestmentfund@gmail.com</a></div><div><p style={{fontFamily:"var(--fs)",fontSize:"13px",fontWeight:600,color:"var(--ink)",marginBottom:"4px"}}>Sophia McCoy - Head of Operations</p><a href="mailto:garnetfundoperations@gmail.com" style={{fontFamily:"var(--fs)",fontSize:"13px",color:"var(--g)",textDecoration:"none",borderBottom:"1px solid var(--g)",paddingBottom:"2px"}}>garnetfundoperations@gmail.com</a></div><div><p style={{fontFamily:"var(--fs)",fontSize:"13px",fontWeight:600,color:"var(--ink)",marginBottom:"4px"}}>Julia Judkins - Alumni Chair</p><a href="mailto:garnetfundalumnichair@gmail.com" style={{fontFamily:"var(--fs)",fontSize:"13px",color:"var(--g)",textDecoration:"none",borderBottom:"1px solid var(--g)",paddingBottom:"2px"}}>garnetfundalumnichair@gmail.com</a></div></div>
            </div>
