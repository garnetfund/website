    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .appsec{background:var(--cr);padding:40px}
        ...
        .alm{padding:40px;background:var(--cr)}
        ...
        .tmp{padding:40px;background:var(--cr)}
        ...
        .jp{padding:40px;background:var(--cr)}
        ...
        .dp{padding:40px;background:var(--cr)}
